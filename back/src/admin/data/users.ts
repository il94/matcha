...
const date1 = dayjs().toString()
const date2 = dayjs().subtract(1, "day").toString()
const date3 = dayjs().subtract(1, "hour").toString()
const date4 = dayjs().subtract(1, "minute").toString()
const date5 = dayjs().subtract(1, "second").toString()
const date6 = dayjs().subtract(1, "month").toString()
